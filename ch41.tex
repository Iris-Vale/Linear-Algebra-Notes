...
\textit{(2)~~证明$M_{m \times n} (\mathbb{K})$是$mn$维线性空间.}\medskip
...
\begin{eq1}
    ...
    k (\bm{\gamma}+\operatorname{Ker}A) &= (k\bm{\gamma}) + \operatorname{Ker}A \end{eq1}
...
\begin{eq1}
    ...
    k \bm{\alpha}_1 - k \bm{\gamma}_1 &= k (\bm{\alpha}_1 - \bm{\gamma}_1) \in \operatorname{Ker}A \end{eq1}
...
这就证明了商空间的维数公式：
\begin{eq1}
    n = \dim\operatorname{Ker}A + \dim\mathbb{K}^n / \operatorname{Ker}A \end{eq1}
...
\begin{eq1}
    ...
    k \phi(\overline{\bm{x}_1})  &=  \phi(k \overline{\bm{x}_1}) \end{eq1}
...
即有如下同构等式：
\begin{eq1}
    \mathbb{K}^n / \operatorname{Ker}A \cong \operatorname{Im}A \end{eq1}
